...
class AnalogEncoder : public ErrorBase,
 ...
 public:
   ...
   */
  AnalogEncoder(int aChannel, bool reverseDirection = false);

  /**
   * Encoder constructor.
   *
   * Construct an Encoder given a and b channels as digital inputs. This is used
   ...
   *//*
  AnalogEncoder(DigitalSource* aSource, 
...
*/
  ...
  AnalogEncoder(std::shared_ptr<DigitalSource> aSource,
          bool reverseDirection = false);
*/
...
*/
   ...
   */
  void SetIndexSource(int channel, Encoder::IndexingType type = Encoder::kResetOnRisingEdge);
  ...
  void SetIndexSource(const DigitalSource& source,
                      Encoder::IndexingType type = Encoder::kResetOnRisingEdge);
*/
  /**
 ...
 private:
   ...
   *                         be double (2x) the spec'd count.
   */
  void InitEncoder(bool reverseDirection);
  ...
  std::shared_ptr<AnalogInput> m_aSource;  // The A phase of the quad encoder
  bool mReversed;
  std::shared_ptr<DigitalSource> m_indexSource = nullptr;
  double mDistancePerPulse {1};
